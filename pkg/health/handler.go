...
type (
	...
	MiddlewareFunc func(r *http.Request) Result

	// ResultWriter enabled a Handler (see NewHandler) to write the Result
	...
	// JSONResultWriter writes a Result in JSON format into an
